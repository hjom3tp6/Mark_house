...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 165, 0, 4775);
    			add_location(button, file, 166, 0, 4827);
    			attr_dev(p0, "class", "text svelte-ou1e89");
    			add_location(p0, file, 169, 4, 4981);
    			attr_dev(div0, "class", "flex-item item1 svelte-ou1e89");
    			add_location(div0, file, 168, 2, 4946);
    			attr_dev(p1, "class", "name svelte-ou1e89");
    			add_location(p1, file, 172, 4, 5056);
    			attr_dev(div1, "class", "flex-item item2 svelte-ou1e89");
    			add_location(div1, file, 171, 2, 5021);
    			attr_dev(div2, "class", "flex-container svelte-ou1e89");
    			set_style(div2, "--flex-container--bg", "url(" + myPic + ")");
    			add_location(div2, file, 167, 0, 4871);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [name, text, shareMsg, input_input_handler];
    }
    ...
    function create_catch_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(t_value);
    			add_location(p, file$1, 53, 2, 1044);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 48, 4, 972);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 46, 4, 938);
    		},
    		m: function mount(target, anchor) {
