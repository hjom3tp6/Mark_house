...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(textarea, "rows", "2");
    			attr_dev(textarea, "class", "svelte-vyzhjn");
    			add_location(textarea, file$1, 142, 4, 3515);
    			attr_dev(div0, "class", "item-input");
    			add_location(div0, file$1, 141, 2, 3485);
    			attr_dev(div1, "class", "box svelte-vyzhjn");
    			add_location(div1, file$1, 140, 0, 3464);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let $myName;
    	validate_store(myPic, "myPic");
    	component_subscribe($$self, myPic, $$value => $$invalidate(2, $myPic = $$value));
    	validate_store(myName, "myName");
    ...
    function create_catch_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(t_value);
    			add_location(p, file$2, 92, 2, 2031);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			if_block.c();
    			add_location(h3, file$2, 76, 4, 1587);
    			attr_dev(div, "class", "box-component svelte-eftmht");
    			add_location(div, file$2, 75, 2, 1539);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(select, file$2, 80, 6, 1672);
    			attr_dev(div, "class", "item-component svelte-eftmht");
    			add_location(div, file$2, 85, 6, 1832);
    			add_location(button, file$2, 88, 6, 1952);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 78, 6, 1634);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file$2, 82, 10, 1747);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(82:8) {#each options as option}",
    		ctx
    	});
    ...
    function create_pending_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			add_location(div, file$2, 73, 2, 1521);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
