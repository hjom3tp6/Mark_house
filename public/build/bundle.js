...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h5 = element("h5");
    			h5.textContent = "傳送成功";
    			add_location(h5, file, 163, 2, 4843);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(163:0) {#if shareMsgSuccess}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*shareMsgSuccess*/ ctx[1] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			p1 = element("p");
    			p1.textContent = `by ${/*name*/ ctx[3]}`;
    			attr_dev(input, "placeholder", "input...");
    			add_location(input, file, 160, 0, 4722);
    			add_location(button, file, 161, 0, 4774);
    			attr_dev(p0, "class", "text svelte-ou1e89");
    			add_location(p0, file, 167, 4, 4976);
    			attr_dev(div0, "class", "flex-item item1 svelte-ou1e89");
    			add_location(div0, file, 166, 2, 4941);
    			attr_dev(p1, "class", "name svelte-ou1e89");
    			add_location(p1, file, 170, 4, 5051);
    			attr_dev(div1, "class", "flex-item item2 svelte-ou1e89");
    			add_location(div1, file, 169, 2, 5016);
    			attr_dev(div2, "class", "flex-container svelte-ou1e89");
    			set_style(div2, "--flex-container--bg", "url(" + /*$myPic*/ ctx[2] + ")");
    			add_location(div2, file, 165, 0, 4865);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function shareMsg() {
    		if (liff.isApiAvailable("shareTargetPicker")) {
    			liff.shareTargetPicker([
    				...
    				if (res) {
    					$$invalidate(1, shareMsgSuccess = true);
    				} else {
    					$$invalidate(1, shareMsgSuccess = false);
    				}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("shareMsgSuccess" in $$props) $$invalidate(1, shareMsgSuccess = $$props.shareMsgSuccess);
    	};
    	...
    	return [text, shareMsgSuccess, $myPic, name, shareMsg, input_input_handler];
    }
     ...
     */
    	function displayLiffData() {
    		$$invalidate(0, isInClient = liff$1.isInClient());
    	}
