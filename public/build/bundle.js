    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h5 = element("h5");
    			h5.textContent = "傳送成功";
    			add_location(h5, file, 176, 4, 5125);
    		},
